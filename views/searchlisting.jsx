...
subfilters.push(
<div>
     <input type="checkbox" data-filtervalue={filtername.value[i].name} data-filter={filtername.name} data-sortingfield="" data-sortingorder="asc" data-start="0" data-rows="12" data-searchtext="*" data-categoryid="" data-value={filterval.value} className="filtergroup" />{filterval.name}
...
<div className="col-md-4  product-home six-product">
    <a href="#"><Img imgSource={'http://54.254.153.83/coreui/glass-old/images/PROD-'+product.variantid+"/"+imagePath2}  imagePath={imagePath2} />
        <h3>{product.name}</h3>
    </a> 
...
data-sessionid="abc99" data-orgid="2" data-customergrp="1" title="ADD TO CART"></span>
     <span className="addw" title="ADD TO WISHLIST"></span>
     <span className="addq quickViewOption" title="QUICK VIEW" data-toggle="modal" data-target="#myModal-11" data-product={this.props.widget.variantid} data-producttype="3" data-customer={this.props.widget.pricecustomergroup}></span>
     <span className="adde expressCheckout" title="EXPRESS CHECKOUT" data-product={product.variantid} data-price={product.priceid} data-qty="1" data-session="abc99" data-org="2"
data-customer="1"></span>
        ...
        <label id="totalCount">Total Count:{this.props.productCount}</label>
                ...
                <div className="row" id="searchlisting">{productrows}</div>
...
var Sortby=React.createClass({
    ...
    render:function(){
       ...
       this.props.sortbyData.sort.forEach(function(sort){
                ...
                sortbyrows.push(
                    <button data-sortingfield={sort.description} data-searchtext="*" data-start="0" data-rows="12" data-sortingorder={sort.value} className="filtergroup" data-filter="" >{sort.name}</button>
                );
        }.bind(this));
...
<Header shopByCategory={this.props.component.header}/>
...
<FooterSection footerData={this.props.component.footer}/>
</footer>
</div>
...
<script src={"http://"+jsPath+"/searchListing-UI.js"} type="text/javascript" ></script>
